...
namespace OpenControls.Wpf.TabHeaderControlDemo.ViewModel
{
    public class MainViewModel : System.ComponentModel.INotifyPropertyChanged
    {
        public MainViewModel()
        {
            ...
            ListBoxItems.Add(new TabHeaderItem() { ID = 0, Label = "Short items", ImageLoc="test.jpg"});
            ListBoxItems.Add(new TabHeaderItem() { ID = 1, Label = "A longer item", ImageLoc = "test.jpg" });
            ListBoxItems.Add(new TabHeaderItem() { ID = 2, Label = "A quite long item", ImageLoc = "test.jpg" });
            ListBoxItems.Add(new TabHeaderItem() { ID = 3, Label = "A really quite long item", ImageLoc = "test.jpg" });
